...
const descBtns = document.querySelectorAll('.product__desc__menu product__desc__button')
const descList = document.querySelectorAll('.desc-pr')

descBtns.forEach((btn) => {
	btn.addEventListener('click', (e) => {
		const typec = e.target.getAttribute('type-desc')
		...
		descList.forEach((item) => {
			if (typec == 'all' || item.getAttribute('type-desc') == typec)
